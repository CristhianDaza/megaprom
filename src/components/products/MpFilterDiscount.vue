...
<template>
  <div class="flex flex-col gap-2">
    <p class="mr-3 text-lg font-semibold text-black-mp dark:text-white/70">Ver solo con descuentos:</p>
    <hr class="mb-2"/>
    <ToggleButton
      id="toggle"
      v-model="checked"
    ...
    />
    <small id="toggle-help" class="text-black-mp dark:text-white/70">
