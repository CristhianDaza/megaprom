...
const emit = defineEmits({ filterByColor: null });
...
<template>
  <div>
    <p class="mb-2 mr-3 text-lg font-semibold text-black-mp dark:text-white/70">Filtrar por Colores:</p>
    <hr class="mb-3" />
