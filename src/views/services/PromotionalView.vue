...
<template>
  <div class="w-[90%] mx-auto my-8">
    <div class="relative">
      <div class="flex flex-col items-end text-[#0e2050] text-right text-[20px] md:text-[40px] leading-tight">
        <p>PROMOCIONALES</p>
      ...
      <div class="text-center leading-none lg:mt-[-20px] md:mt-[-5px] mt-2">
        ...
        <p class="text-pink-600 text-[25px] md:text-[2.5rem] font-medium font-futura">
          <span class="mx-2 text-[#0e2050]">•</span>
          NUESTROS
          <span class="mx-2 text-[#0e2050]">•</span>
        </p>

        <h1
          class="text-[#0e2050] text-[100px] md:text-[220px] lg:text-[270px] inline-block relative font-creamy scale-x-125 mt-[-30px] md:mt-[-60px] lg:mt-[-80px]">
          Promocionales
        </h1>

        <p
          class="text-pink-600 text-[20px] md:text-[2rem] font-medium lg:mt-[-80px] md:mt-[-70px] mt-[-30px] font-futura">
    ...
    <div
      class="text-[#0e2050] mx-auto w-[80%] mt-[3rem] md:mt-[5rem] font-bold flex flex-col text-center items-center text-[18px] md:text-[1.5rem] leading-none">
      <p class="text-center">
        ...
        <div class="flex justify-between items-start flex-wrap items-center">
          ...
          <div class="flex flex-col text-center leading-none mt-4">
            ...
            <div class="mt-[-55px] relative">
              <p class="text-[#0e2050] text-[100px] md:text-[150px] font-creamy">Escritura</p>
