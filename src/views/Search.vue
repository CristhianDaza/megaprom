  ...
  <template v-else>
    ...
    >
      <div class="flex w-full gap-2 flex-wrap">
        <div v-if="getMaxQuantity > 0" class="bg-white-mp dark:bg-dark-mp border border-gray-600 dark:border-gray-700 rounded-xl p-4 md:w-[280px] w-auto shadow-lg transition-all duration-300 ease-in-out">
          <MpFilterQuantity
            :value="inventory"
        ...
        <div v-if="countDiscountedProducts > 0" class="bg-white-mp dark:bg-dark-mp border border-gray-600 dark:border-gray-700 rounded-xl p-4 md:w-[280px] w-auto shadow-lg transition-all duration-300 ease-in-out">
          <MpFilterDiscount
            :totalProducts="countDiscountedProducts"
            @filterDiscount="filterDiscount"
          />
        </div>
        <div class="bg-white-mp dark:bg-dark-mp border border-gray-600 dark:border-gray-700 rounded-xl p-4  md:w-[280px] w-auto shadow-lg transition-all duration-300 ease-in-out">
          <MpFilterColor
